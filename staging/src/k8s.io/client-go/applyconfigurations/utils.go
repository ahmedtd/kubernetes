...
func ForKind(kind schema.GroupVersionKind) interface{} {
	...
	case v1alpha1.SchemeGroupVersion.WithKind("ClusterTrustBundle"):
		return &certificatesv1alpha1.ClusterTrustBundleApplyConfiguration{}
	case v1alpha1.SchemeGroupVersion.WithKind("ClusterTrustBundleSpec"):
		return &certificatesv1alpha1.ClusterTrustBundleSpecApplyConfiguration{}
