...
type ClusterTrustBundleSpecApplyConfiguration struct {
	...
	PEMTrustAnchors *string `json:"pemTrustAnchors,omitempty"`
}
...
// WithPEMTrustAnchors sets the PEMTrustAnchors field in the declarative configuration to the given value
// and returns the receiver, so that objects can be built by chaining "With" function invocations.
// If called multiple times, the PEMTrustAnchors field is set to the value of the last call.
func (b *ClusterTrustBundleSpecApplyConfiguration) WithPEMTrustAnchors(value string) *ClusterTrustBundleSpecApplyConfiguration {
	b.PEMTrustAnchors = &value
	return b
}
