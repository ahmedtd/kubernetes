...
func (c *FakeCertificatesV1alpha1) WorkloadCertificates(namespace string) v1alpha1.WorkloadCertificateInterface {
	return &FakeWorkloadCertificates{c, namespace}
}
