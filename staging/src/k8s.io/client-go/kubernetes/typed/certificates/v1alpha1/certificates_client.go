...
func (c *CertificatesV1alpha1Client) WorkloadCertificates(namespace string) WorkloadCertificateInterface {
	return newWorkloadCertificates(c, namespace)
}
