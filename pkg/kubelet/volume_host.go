...
func (kvh *kubeletVolumeHost) GetClusterTrustBundleFunc() func(name string) (*certificatesv1alpha1.ClusterTrustBundle, error) {
	return kvh.clusterTrustBundleManager.GetClusterTrustBundle
}
