...
func newStorage(t *testing.T) (*REST, *etcd3testing.EtcdTestServer) {
	etcdStorage, server := registrytest.NewEtcdStorageForResource(t, certificates.Resource("clustertrustbundles"))
...
func TestCreate(t *testing.T) {
	...
	invalidBundle := &certificates.ClusterTrustBundle{
		...
		Spec: certificates.ClusterTrustBundleSpec{
			// Empty PEMTrustAnchors is invalid.
		},
	}
...
func TestUpdate(t *testing.T) {
	...
	test.TestUpdate(
		...
		func(object runtime.Object) runtime.Object {
			...
			bundle.Spec.PEMTrustAnchors = strings.Join([]string{validCert1, validCert2}, "\n")
			return bundle
		},
		// Invalid update
		func(object runtime.Object) runtime.Object {
			bundle := object.(*certificates.ClusterTrustBundle)
			bundle.Spec.PEMTrustAnchors = ""
			return bundle
		},
	)
}
