...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ClusterTrustBundlePEMProjection) DeepCopyInto(out *ClusterTrustBundlePEMProjection) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ClusterTrustBundlePEMProjection.
func (in *ClusterTrustBundlePEMProjection) DeepCopy() *ClusterTrustBundlePEMProjection {
	if in == nil {
		return nil
	}
	out := new(ClusterTrustBundlePEMProjection)
	in.DeepCopyInto(out)
	return out
}
...
func (in *VolumeProjection) DeepCopyInto(out *VolumeProjection) {
	*out = *in
	...
	if in.ClusterTrustBundlePEM != nil {
		in, out := &in.ClusterTrustBundlePEM, &out.ClusterTrustBundlePEM
		*out = new(ClusterTrustBundlePEMProjection)
		**out = **in
	}
	return
